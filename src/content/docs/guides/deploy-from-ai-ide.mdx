...
description: Deploy any Node or Python app to production from inside your AI editor. Install the Varity MCP server once, then type "deploy this" and your app is live.
---
...
| `varity_set_env` | "Set this environment variable on my app" |
| `varity_redeploy` | "Redeploy this app" |
