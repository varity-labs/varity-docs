...
Deploy your application to Varity L3, an Arbitrum Orbit rollup optimized for applications.

<Aside type="note">
**Testnet Mode** - Varity L3 testnet is currently active. Mainnet launch will follow MVP validation.
</Aside>
...
| **Status** | **TESTNET** - Mainnet launch post-MVP |
