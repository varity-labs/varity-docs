...
Varity L3 is an Arbitrum Orbit rollup where your app is registered. It's:
- **Chain ID**: `33529`
- **Fast**: Sub-second confirmations
- **Cheap**: Fractions of a cent per transaction
- **Gasless**: Users never pay fees

### Do I need to know about blockchain or cryptocurrency?

**No.** Varity abstracts all blockchain complexity:
- Users log in with email (not cryptocurrency wallets)
