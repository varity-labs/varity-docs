...
Varity is a newly launched platform in guided beta. This page is the honest snapshot of what works today, what is beta, and what is not ready yet, so nothing surprises you after you deploy.
...
- Rollback to a previous deployment; recover by [redeploying a known-good version](/deploy/rollback/)
- Cron jobs and scheduled tasks
- Preview deployments
- Multi-region app hosting and an edge runtime (static files are still served over a CDN)
