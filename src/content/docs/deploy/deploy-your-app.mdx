...
| **A Docker image** | `varitykit app deploy --image <ref>` — see [Deploy a Docker Image](/deploy/deploy-docker-image) | Prebuilt runnable HTTP service images, including unsupported source-language apps once containerized |
...
| Option | Default | Description |
|--------|---------|-------------|
| `--image` | — | Runnable HTTP service image reference (e.g. `ghcr.io/acme/api:1.4.2`) |
