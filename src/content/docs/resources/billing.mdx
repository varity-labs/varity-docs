...
Each paid app bills **up to a fixed monthly maximum**, based on the resources that app reserves, prorated by the time it runs. GPU machines are the exception: they bill by the hour with no monthly cap. See [GPU machines](/machines/gpu/).
