...
<Aside type="tip">
**Development Mode:** Varity provides shared development credentials that work automatically. Skip the environment variables and the UI Kit will use development defaults.
</Aside>
...
- [@varity/sdk](/packages/sdk/overview) - Backend SDK
