---
title: "Glossary"
description: "Definitions of key Varity terms: App Store, deploy keys, managed credentials, revenue splits, SDK packages, and infrastructure concepts."
---
...
=======
How revenue is divided between you and the platform (90/10 split):
- **90%** goes to you (the developer)
- **10%** goes to Varity

### Native Currency

The currency used on Varity is a stablecoin pegged to the US dollar.

**Equivalent:** Just think of it as USD. $1 = $1 USD.

<Aside type="note">
Payments on Varity use 6 decimal places.
>>>>>>> e29b089d895ea4e653849a742d38ee6ad100199c
...
| Node | Server |
| Distributed Storage | Secure distributed storage |
...
A storage network where files are replicated across multiple nodes worldwide for durability and availability.

**Equivalent:** A global CDN with content-addressed URLs.

### Distributed Compute

A cloud computing marketplace where providers compete to run your application, driving costs down.
