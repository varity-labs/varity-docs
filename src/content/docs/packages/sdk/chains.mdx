...
<<<<<<< HEAD
description: "Varity SDK infrastructure configuration: USDC handling with 6 decimals, formatUSDC/parseUSDC helpers, and auto-configured network settings."
=======
...
<<<<<<< HEAD
<Aside type="caution">
**Advanced users only.** This page covers low-level infrastructure details for integrating directly with the Varity L3 network. Most developers do not need this — the SDK and CLI handle everything automatically.
</Aside>
