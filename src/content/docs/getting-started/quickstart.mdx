---
title: Quick Start
description: Get started with Varity in minutes. Migrate an existing app or deploy from your AI coding tool with the MCP server.
---
...
Two ways to get started. Pick the one that fits where you are today.
...
## Path 2: Build from scratch with AI tools
