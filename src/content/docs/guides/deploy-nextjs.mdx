...
<CardGrid>
  ...
  <Card title="60-80% cheaper than Vercel, Render, or Railway" icon="seti:money">
    One flat monthly cost per app. Your bill does not change with traffic. No DevOps overhead.
  </Card>
</CardGrid>
