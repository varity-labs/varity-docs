---
title: Introduction
description: Varity is predictable cloud hosting for any Node or Python app, AI agent, or LLM app. One flat monthly bill, with zero infrastructure to manage.
---
...
Varity is predictable cloud hosting for any Node or Python app, AI agent, or LLM app. Point it at your project, and your app is live with one command, at a flat monthly cost that does not change with traffic.
