...
Usage metered hosting charges more as more people use your app. Varity bills each app up to a fixed monthly maximum set by the hardware profile you reserve, prorated by the time it runs.
...
Varity may not be the right fit yet if you need cron jobs, preview deployments, rollback to a previous deployment, or a source build for Rust, Ruby, Elixir, Java, Deno, PHP, or .NET.
