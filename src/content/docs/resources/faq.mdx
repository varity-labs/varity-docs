...
**Not yet supported for source builds:** Rust, Ruby / Rails, Elixir / Phoenix, Java / Spring, Deno, PHP / Laravel, .NET. Deploying these from source will fail with an unsupported-language error. You can still deploy them as runnable Docker images. [Request framework support](https://github.com/varity-labs).
