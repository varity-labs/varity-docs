...
Add passwordless email login to your app. Users receive a magic link - no passwords to remember, no password resets to handle.
...
import { usePrivy, useLogin } from '@varity/ui-kit';
...
import { PrivyProtectedRoute, usePrivy } from '@varity/ui-kit';
