...
![Varity dashboard source repository deploy form with GitHub URL input](/docs/images/dashboard-source-repository.webp)

![Varity dashboard template gallery with verified starter apps](/docs/images/dashboard-template-gallery.webp)
