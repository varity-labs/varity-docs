---
title: Supported Frameworks on Varity
...
Varity also does not yet offer cron jobs, multi-region app hosting, an edge runtime, or preview deploys. CPU VMs and GPU machines are a separate product where you do pick the region.
