...
description: Varity automatically configures everything for your app - no setup files, no DevOps knowledge required. Just build and deploy. 60-80% cheaper than traditional platforms.
sidebar:
  badge:
    text: Beta
    variant: note
