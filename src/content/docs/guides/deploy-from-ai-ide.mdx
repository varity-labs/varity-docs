...
![Varity MCP setup command for Claude Code and compatible AI editors](/docs/images/ai-editor-mcp-setup.webp)
...
| `varity_list_agents` | "What AI agent templates can Varity deploy?" |
| `varity_agent_info` | "What does the Agent Zero template need?" |
| `varity_deploy_agent` | "Deploy Agent Zero with these environment variables" |
