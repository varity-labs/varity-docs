...
**Not yet supported for source builds:** Rust, Ruby / Rails, Elixir / Phoenix, Java / Spring, Deno, PHP / Laravel, .NET. These return a clean error with a feature-request link instead of failing midway. [Request support for your framework](https://github.com/varity-labs).
