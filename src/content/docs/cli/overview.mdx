...
description: "VarityKit CLI overview: run diagnostics, migrate Vercel apps, deploy apps, and manage domains. Python-based deployment toolchain."
---
...
| [`varitykit init`](/cli/commands/init) | Legacy scaffolding command (not part of the primary MVP flow) |
...
### Legacy Commands (not part of current MVP flow)

| Command | Description |
|---------|-------------|
| `varitykit template ...` | Legacy template tooling (not primary launch path) |
| `varitykit marketplace ...` | Legacy marketplace tooling (not primary launch path) |
