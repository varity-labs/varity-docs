...
description: Revert to a previous deployment with varitykit app rollback <id>. Find deployment IDs with varitykit app list, then restore any prior version in seconds.
---
