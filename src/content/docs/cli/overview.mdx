...
**Not yet supported:** Go, Rust, Ruby / Rails, Elixir / Phoenix, Java / Spring, Deno, PHP / Laravel, .NET. These are not auto-detected yet — the CLI returns a clean error with a feature-request link instead of failing midway. [Request support for your framework](https://github.com/varity-labs).
