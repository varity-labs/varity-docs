---
title: "VarityKit CLI Overview Guide"
...
<CardGrid>
  ...
  <Card title="Manage Deployments" icon="list-format">
    List deployments, check status, and redeploy a known-good version when needed.
  </Card>
...
| `varitykit app info <app-name>` | Show deployment details |
| `varitykit app status` | Show your most recent deployment |
| `varitykit app delete <app-name> --yes` | Delete a deployment |
...
- **Features**: Containers, auto-wired services, persistent volumes
...
| Astro | Supported | Supported |
| Qwik | Supported | Supported |
| Vite SPA | Supported | Not applicable |
