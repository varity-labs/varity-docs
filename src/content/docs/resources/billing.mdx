---
title: Billing
description: How Varity billing works — a card on file before your first deploy, and a flat monthly price per app that doesn't change with traffic.
---
...
Your dashboard shows the monthly cost for each app and your overall bill. Because the price is fixed per app, the number you see is the number you pay — there's no end-of-month surprise from a traffic spike.
