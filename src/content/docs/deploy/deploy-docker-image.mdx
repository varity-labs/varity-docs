...
You can also request deletion from the Developer Portal. Follow the resulting
state until cleanup and billing closure are terminal; acceptance alone is not
proof that either has completed.
