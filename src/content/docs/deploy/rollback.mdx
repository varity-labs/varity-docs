...
description: Revert, undo, or roll back to a previous deployment version using varitykit app rollback <id>. Find deployment IDs with varitykit app list, then restore any prior version in seconds.
---
