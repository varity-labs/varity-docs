---
title: Quick Start
description: Get your first Varity app running in 5 minutes. Install the SDK and UI Kit, add authentication, connect a database, and deploy.
---
...
- [Add payments](/build/payments/quickstart) - Monetize your app
