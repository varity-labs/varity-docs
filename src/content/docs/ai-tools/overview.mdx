...
Then ask your AI to "create a Varity app" or "deploy this project" — it has 7 tools for the full build-to-monetize workflow. See the [MCP Server Spec](/ai-tools/mcp-server-spec) for the complete tool reference.
...
| **Claude Desktop** | MCP Server (stdio) | Full |
