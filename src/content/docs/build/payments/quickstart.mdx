...
description: "Set pricing, submit your app to the Varity App Store, and earn revenue with a 90/10 split. No payment integration code required."
---
...
|-----------|-------|---------|
| **You** (developer) | **90/10 split** | You keep 90%, deposited monthly |
...
5. **You earn revenue** — 90/10 split (you keep 90%), deposited monthly
