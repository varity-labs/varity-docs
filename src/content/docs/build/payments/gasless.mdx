...
<Aside type="tip">
**No configuration needed.** Free operations are built into the platform. When you deploy with `varitykit app deploy`, your app automatically gets free operations for end users.
</Aside>
...
## Collecting Payments from Users (Coming Soon)

<Aside type="caution">
**Coming Soon** — Payment components are under active development. The APIs below show what's planned but are not yet available for use.
</Aside>

While operations are free, you'll be able to charge users for your app or premium features using the payment components from `@varity-labs/ui-kit`.
...
=======
All of this happens in seconds, completely invisible to users. The smart account infrastructure (ZeroDev Kernel smart accounts, authentication, Conduit for bundler and paymaster) is managed by Varity. Developers do not need to configure any of these components.
>>>>>>> e29b089d895ea4e653849a742d38ee6ad100199c
