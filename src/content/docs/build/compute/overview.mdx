...
Run backend services, scheduled jobs, and server-side code on decentralized infrastructure.

## What's Coming

### Decentralized Compute (Akash Network)
...
| Feature | Status |
|---------|--------|
| Static hosting (IPFS) | Available |
| Dynamic hosting (Akash) | Coming Soon |
...
- [Deploy static sites](/deploy/varity-l3) - IPFS hosting is live
...
- [Deploy to IPFS](/deploy/varity-l3) - Deploy static apps now
