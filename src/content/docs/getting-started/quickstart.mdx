---
title: Quick Start with Varity Docs
...
3. **Your app is live**
   ...
   Once the deploy finishes, your app is available at the URL for its hosting type:
...
| React (Vite or CRA) | Static | Supported |
| Vue | Static | Supported |
| Astro | Static | Supported |
| Qwik | Static | Supported |
| Vite SPA | Static | Supported |
| Plain static HTML | Static | Supported |
| Express / Fastify / Nest / Koa / Hono | Server | Supported |
| FastAPI | Server | Supported |
| Django | Server | Supported |
| Flask | Server | Supported |
| Go modules | Server | Supported |
| Runnable Docker / OCI HTTP images | Server | Supported |

For the full detection matrix, see [Supported Frameworks](/deploy/supported-frameworks/).
