...
description: "Set pricing, submit your app to the App Store (post-beta), and earn revenue with a 90/10 split. No payment integration code required."
---
...
Monetize your app through the App Store (post-beta). Set your price, deploy, and earn revenue automatically.
...
2. **Deploy and submit** to the App Store (post-beta)
...
4. **Users discover and purchase** your app on store.varity.so (post-beta).
...
<Aside type="note">
For App Store sales, users complete purchase through the post-beta checkout surface. In-app `PaymentWidget` is for subscription upgrades within your deployed app.
</Aside>
...
1. **Find your app** in the App Store (post-beta)
...
- [Deploy Your App](/deploy/deploy-your-app): App Store status (post-beta)
