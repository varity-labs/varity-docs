---
title: Deploy a Docker Image on Varity
...
This is also the path for languages Varity does not build from source yet (Rust, Ruby / Rails, Elixir / Phoenix, Java / Spring, Deno, PHP / Laravel, and C# / .NET): package your app as a runnable HTTP service image and deploy it like any other container.
