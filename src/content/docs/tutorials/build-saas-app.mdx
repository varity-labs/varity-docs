...
description: "Step-by-step tutorial: scaffold a SaaS app with varitykit init, explore the dashboard and auth, then deploy it live with one command."
---
...
8. **App Store status (post-beta) (optional)**
   ...
   - Upload screenshots
   - Publish to [store.varity.so (post-beta)](https://store.varity.so)
