...
description: Move your existing Vercel app to Varity in one command. The CLI and MCP tools handle code transforms, dependency cleanup, and deployment automatically.
---
...
Move your existing Vercel app to Varity in one command. The migration tool removes Vercel-specific code, installs Varity packages, and deploys your app automatically.
