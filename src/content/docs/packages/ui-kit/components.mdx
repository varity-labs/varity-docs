...
// Create thirdweb client (required for all smart wallet operations)
...
Prevents a blank screen during Privy initialization (5-15 seconds).
...
Full payment widget for buying USDC with a credit card.
