...
description: Production-ready SaaS template with authentication, Varity database, team management, CRUD pages, and a full dashboard. One-command scaffold.
---
