...
<Tabs>
  ...
  With the [Varity MCP server](/ai-tools/mcp-server-spec) installed, ask your AI editor to deploy the image with `varity_deploy`:

  > "Deploy the flowiseai/flowise image on Varity"
