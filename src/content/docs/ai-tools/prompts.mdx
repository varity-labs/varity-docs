...
- Use the App Store (post-beta) for payment processing
...
- `varitykit app deploy` — Deploy and submit to App Store
...
- For local dev, set NEXT_PUBLIC_VARITY_APP_TOKEN and NEXT_PUBLIC_VARITY_DATABASE_URL in .env.local, or build UI with mock data first
